...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader
                .getResource("/etc/sso-secret-volume/Keystore.jks");
        String storePass = "admin123";
        Map<String, String> passwords = new HashMap<String, String>();
        passwords.put("apollo", "admin123");
  ...
  @Bean 
 @Qualifier("metadata") 
public CachingMetadataManager metadata(List<MetadataProvider> providers) throws MetadataProviderException { return new CachingMetadataManager(providers); }
